                ...
                if (misFunciones.badUser(edtUsuario.getText().toString())) {
                    ...
                    try {
                        ...
                        if (respuesta2[0] == null) {
                            misFunciones.WarningMessages(getActivity(), getString(R.string.inexistentUser));
                        } else {
                            if(respuesta2[2].toString().equals("1")){
                                misFunciones.WarningMessages(getActivity(), getString(R.string.adminUser));
                            } else {
                                camposPassword(View.VISIBLE);
                                camposEmpresa(View.VISIBLE);
                                                ...
                                                .setPositiveButton("Si", new DialogInterface.OnClickListener() {
                                                    public void onClick(DialogInterface dialog, int id) {
                                                        ...
                                                        try{
                                                            ...
                                                            if(respuesta == 1){
                                                                misFunciones.WarningMessages(getActivity(), getString(R.string.confDelete));
                                                                nuevoClick();
                                                            } else {
                                                                misFunciones.WarningMessages(getActivity(), getString(R.string.userNotFound));
                                                            }
                                                        } catch (InterruptedException e){
                                                        } catch (ExecutionException e){
                                                        }
                    ...
                    switch (bandera) {
                        ...
                        case 2:
                            if(exito){
                                ...
                                Integer respuesta = miCon.execute(misFunciones.datosLlamada(miPagina, miWhere)).get();
                                if(respuesta == 1){
                                    misFunciones.WarningMessages(getActivity(), getString(R.string.confUpdate));
                                    camposUsuario(View.VISIBLE);
                                    camposPassword(View.GONE);
                                    camposEmpresa(View.GONE);
                                    camposBuscar(View.VISIBLE);
                                    ...
                                    misFunciones.WarningMessages(getActivity(), getString(R.string.noModWarning));
                                }
                            }
                            break;
                    }
